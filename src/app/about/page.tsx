...
const COPY = {
  ...
  fr: {
    ...
    values: [
      ...
      { title: "Privacy by Design", desc: "Chaque décision produit commence par la vie privée. Le sans-cookie n'est pas une contrainte — c'est notre fondation.", accent: "#07e2dc" },
