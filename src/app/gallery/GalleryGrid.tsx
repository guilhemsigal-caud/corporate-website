            ...
            >
              <Link
                ...
                style={{
                  ...
                  background: `linear-gradient(145deg, ${item.accent}18 0%, #eef0fb 100%)`,
              ...
              >
                ...
                <div className="relative flex flex-col h-full">
                  ...
                  <div className="flex items-center justify-between mb-4">
                    ...
                    {item.demos && item.demos.length > 0 && (
                      <span
                        ...
                        style={{ color: item.accent, borderColor: `${item.accent}35`, background: `${item.accent}0a` }}
                      >
                  ...
                  <h3 className="text-xl font-bold text-ca-text mb-2 leading-snug">{item.name}</h3>
                  ...
                  <div className="flex flex-wrap gap-3 pt-4 border-t mb-4" style={{ borderColor: `${item.accent}25` }}>
                    {item.kpis.map((kpi) => (
                      <div key={kpi.label}>
                        ...
                        <span className="text-[10px] text-ca-muted ml-1">{kpi.label}</span>
                      </div>
                    ))}
                  </div>
