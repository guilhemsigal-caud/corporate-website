...
const COPY = {
  ...
  fr: {
    ...
    editDesc: "Formats conversationnels et interactifs déployés directement dans vos articles. Ils génèrent 34 secondes d'attention en moyenne — et n'interrompent jamais l'expérience de lecture.",
