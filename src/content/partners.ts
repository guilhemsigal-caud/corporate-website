...
export const WHO_WE_HELP_PARTNERS: Partner[] = [
  ...
  { name: "L'Oréal", slug: "loreal", logo: "/partners/loreal.svg" },
  { name: "Louis Vuitton", slug: "louis-vuitton", logo: "/partners/louis-vuitton.png" },
  { name: "BNP Paribas", slug: "bnp-paribas", logo: "/partners/bnp-paribas.svg" },
];
...
export const BRAND_PARTNERS: Partner[] = [
  ...
  { name: "Nestlé", slug: "nestle", logo: "/partners/nestle.svg" },
  ...
  { name: "TotalEnergies", slug: "totalenergies", logo: "/partners/totalenergies.svg" },
  { name: "LVMH", slug: "lvmh", logo: "/partners/lvmh.svg" },
  { name: "Sanofi", slug: "sanofi", logo: "/partners/sanofi.svg" },
  { name: "BoursoBank", slug: "boursobank", logo: "/partners/boursobank.png" },
