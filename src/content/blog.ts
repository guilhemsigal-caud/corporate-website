...
Publishers who have relied on third-party audience segments for programmatic revenue are already seeing CPM pressure. DSPs can no longer accurately identify users, which reduces targeting precision and (and ultimately) advertiser willingness to pay.
...
3. **Build a consent-first CRM**: Every reader interaction should feed a first-party profile, including article reads, interaction events, declared preferences. With proper consent management (IAB TCF 2.x compliant), this data is GDPR-safe and highly durable.
...
The combination of BeOp and NYIAX was not a typical tech merger. Both companies shared the same thesis: the open web deserved better infrastructure, with complementary capabilities that, together, created something neither could build alone.
