/**
 * Imports all static gallery items from gallery.ts into Sanity.
 * Run once: node scripts/seed-gallery.mjs
 * Safe to re-run — uses createOrReplace so existing docs are updated.
 */
...
// Inline the gallery items (avoids TS import in plain .mjs)
const GALLERY_ITEMS = [
  {
  ...
  },
  {
    ...
    demos: [
      { label: "Démo 1", url: "https://demo.collectiveaudience.co/?beop_brand=5a4c9fc4c9e77c00015c3811&beop_content=6250242f01322c33d37e593f&sa=1", scriptUrl: "https://tw.collectiveaudience.co/local/dist/creative-connect-web.min.js?ba=5aa9175a46e0fb00011583af&bca=6250231801322c33d37d9f3e&bi=6250231801322c33d37d9f3e&bco=6250231801322c33d37d9f3e&bs=&bm=preview&bw=&bh=&bsln=embed-6250231801322c33d37d9f3e&clk=" },
      { label: "Démo 2", url: "https://demo.collectiveaudience.co/?beop_brand=5e1317b646e0fb00012a5310&beop_content=67f7c91ffd30d544c0c52f86" },
      { label: "Démo 3", url: "https://demo.collectiveaudience.co/?beop_brand=5c921a6546e0fb000117bbdd&beop_content=5ffc7b12ed6e8a1f05b88189" },
      { label: "Démo 4", url: "https://demo.collectiveaudience.co/?beop_brand=5e1317b646e0fb00012a5310&beop_brand_exit=5e316ddb46e0fb00018367dd&beop_content=6231fee2c2c8b05f9e419c6f&sa=1" },
      { label: "Démo 5", url: "https://demo.collectiveaudience.co/?beop_brand=5a5292e1c9e77c00017f3b55&beop_content=67b2f983338aa3790276e8b9" },
      { label: "Démo 6", url: "https://demo.collectiveaudience.co/?beop_brand=5aa9175a46e0fb00011583af&beop_content=619638153d84ec56ebbe48b7&sa=1" },
      { label: "Démo 7", url: "https://demo.collectiveaudience.co/?beop_brand=61572788b433244130bf1b31&beop_content=62038ca1ad5e4a5fa990de7d" },
    ],
  },
  {
    ...
    demos: [
      { label: "Démo 1", url: "https://demo.collectiveaudience.co/?beop_brand=5de63c4c46e0fb000144acba&beop_content=606f12ef4e99b70a6814689b&sa=1" },
      { label: "Démo 2", url: "https://demo.collectiveaudience.co/?beop_brand=603fb19efa390a60cb8164ca&beop_content=609043057a87004a98d65791" },
      { label: "Démo 3", url: "https://demo.collectiveaudience.co/?beop_brand=5c6bfc1546e0fb0001beec8a&beop_content=600ea502c036227cd340a3c1" },
      { label: "Démo 4", url: "https://demo.collectiveaudience.co/?beop_brand=6036b95ffbdc2244bc8b5707&beop_content=67fd25fffd30d544c0291dad" },
      { label: "Démo 5", url: "https://demo.collectiveaudience.co/?beop_brand=5e457818c9e77c000106507d&beop_content=67fd2328fd30d544c0273188" },
    ],
  },
  {
    ...
    demos: [
      { label: "Démo 1", url: "https://demo.collectiveaudience.co/?beop_brand=60b7f2cbb81f0074d380f8bf&beop_content=622a5e5c17c75344d0a55265" },
      { label: "Démo 2", url: "https://demo.collectiveaudience.co/?beop_brand=5de63c4c46e0fb000144acba&beop_content=60edc787eafa03548154caeb" },
      { label: "Démo 3", url: "https://demo.collectiveaudience.co/?beop_brand=625f11defa66fd3ace01d3a4&beop_content=633be30e9be4d47413711128" },
      { label: "Démo 4", url: "https://demo.collectiveaudience.co/?beop_brand=619e7d02828c51664ebc53e7&beop_content=61a78301f4a52c45f9dacfd5" },
      { label: "Démo 5", url: "https://demo.collectiveaudience.co/?beop_brand=660ec3907bd1df3f45844973&beop_content=67fcc785fd30d544c0ec21bc" },
      { label: "Démo 6", url: "https://demo.collectiveaudience.co/?beop_brand=602546bce3d2b23b9fa5c51e&beop_content=67fcc426fd30d544c0ea1dec" },
    ],
  },
  {
...
async function seed() {
  console.log(`Seeding ${GALLERY_ITEMS.length} gallery items into Sanity…\n`);
  ...
  for (const item of GALLERY_ITEMS) {
    const doc = {
      ...
      accent: item.accent,
      tags: item.tags ?? [],
      kpis: (item.kpis ?? []).map((k, i) => ({ _key: `kpi-${i}`, label: k.label, value: k.value })),
      demos: (item.demos ?? []).map((d, i) => ({
        _key: `demo-${i}`,
        label: d.label,
        url: d.url,
        ...(d.scriptUrl ? { scriptUrl: d.scriptUrl } : {}),
      })),
      ...(item.fr
        ? {
            fr: {
              description: item.fr.description,
              kpis: (item.fr.kpis ?? []).map((k, i) => ({ _key: `kpi-fr-${i}`, label: k.label, value: k.value })),
            },
          }
        : {}),
    };
  ...
  console.log("\nDone! All gallery items are now in Sanity.");
}
